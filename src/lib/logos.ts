...
export const EMBLEMS: Emblem[] = [
  ...
  { icon: "⚽", name: "Pallone calcio" }, { icon: "🏀", name: "Basket" }, { icon: "🏐", name: "Pallavolo" },
  { icon: "🎾", name: "Tennis" }, { icon: "🏓", name: "Ping pong" }, { icon: "🤾", name: "Pallamano" },
  { icon: "🤽", name: "Pallanuoto" }, { icon: "🏉", name: "Rugby" }, { icon: "🏒", name: "Hockey" },
  { icon: "🎯", name: "Freccette" }, { icon: "🥅", name: "Porta" }, { icon: "🏆", name: "Trofeo" },
