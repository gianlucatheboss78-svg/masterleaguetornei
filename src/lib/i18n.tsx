...
import { VOLLEY_DICTS } from "./i18n-volley";
...
const it: Dict = {
  ...
  "home.tornei": "Tornei",
  "home.tagline": "12 sport · squadre illimitate · live · classifiche",
...
const en: Dict = {
  ...
  "home.tagline": "12 sports · unlimited teams · live · standings",
...
const es: Dict = {
  ...
  "home.tornei": "Torneos",
  "home.tagline": "12 deportes · equipos ilimitados · en vivo · clasificaciones",
  ...
  "pro.b2": "12 deportes disponibles",
...
const fr: Dict = {
  ...
  "home.tagline": "12 sports · équipes illimitées · live · classements",
  ...
  "home.share": "Partager",
  "home.chat": "Chat",
  "share.title": "Partager le tournoi",
...
const pt: Dict = {
  ...
  "home.tagline": "12 desportos · equipas ilimitadas · live · classificações",
  ...
  "pro.b2": "12 desportos disponíveis",
  "pro.b3": "Biblioteca de 1000 logos",
...
const zh: Dict = {
  ...
  "home.tornei": "赛事",
  "home.tagline": "12 项运动 · 无限球队 · 实时 · 积分榜",
  "home.new": "+ 新建赛事",
...
const DICTS: Record<Lang, Dict> = {
  it: { ...it, ...GROUP_DICTS.it, ...TENNIS_DICTS.it, ...BASKET_DICTS.it, ...VOLLEY_DICTS.it },
  en: { ...en, ...GROUP_DICTS.en, ...TENNIS_DICTS.en, ...BASKET_DICTS.en, ...VOLLEY_DICTS.en },
  es: { ...es, ...GROUP_DICTS.es, ...TENNIS_DICTS.es, ...BASKET_DICTS.es, ...VOLLEY_DICTS.es },
  fr: { ...fr, ...GROUP_DICTS.fr, ...TENNIS_DICTS.fr, ...BASKET_DICTS.fr, ...VOLLEY_DICTS.fr },
  pt: { ...pt, ...GROUP_DICTS.pt, ...TENNIS_DICTS.pt, ...BASKET_DICTS.pt, ...VOLLEY_DICTS.pt },
  zh: { ...zh, ...GROUP_DICTS.zh, ...TENNIS_DICTS.zh, ...BASKET_DICTS.zh, ...VOLLEY_DICTS.zh },
};
